...
func NewService(repository *repository.Repository, bcrypt bcrypt.Interface, jwtAuth jwt.Interface, supabase supabase.Interface, midtransConfig *config.MidtransConfig, hasher hash.Interface) *Service {
	...
	return &Service{
		...
		AuthService:              NewAuthService(repository.UserRepository, repository.RoleRepository, repository.RegistrationRepository, repository.AdminPoskoProfileRepository, repository.DonorProfileRepository, repository.RevokedTokenRepository, bcrypt, jwtAuth, hasher, repository.StoreRepository),
